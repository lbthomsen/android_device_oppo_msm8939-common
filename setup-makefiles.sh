...
LINEEND=" \\"
COUNT=`wc -l ../../$VENDOR/msm8939-common/device-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../../$VENDOR/msm8939-common/device-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
for FILE in `egrep -v '(^#|^$)' ../../$VENDOR/msm8939-common/device-proprietary-files.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
